...
### 🔧 v3.6.x パフォーマンス修正（v3.5.1の問題に対応）
> [!INFO]
> - **v3.5.1** で発生していたパフォーマンス低下の問題は、**v3.6.0** 以降で修正されています。
> - 特に「**タブを一覧表示します**」パネルを開く速度が大きく改善され、**v3.5.8** と比べて最大で約 **17倍** 高速になりました。
> - **v3.5.1 以降** をお使いの方は、**v3.6.0 以降** へのアップデートをおすすめします。
